...
module.exports.onLoad = () => {
    ...
    if (!fs.existsSync(dirMaterial + "boxthanh.gif")) request("https://i.imgur.com/ilWVWiP.gif").pipe(fs.createWriteStream(dirMaterial + "boxthanh.gif"));
}
